            ...
            {products.length > 0 ? <>
              ...
              {products.map(product => (
                <div className='flex items-center hover:bg-gray-100 -mx-8 px-6 py-5' key={product.id}>
                  ...
                  <span className="text-center w-1/5 font-semibold text-sm">{product.price} Rwf</span>
                  <span className="text-center w-1/5 font-semibold text-sm">{product.discountPrice} Rwf</span>
                </div>
              ))}
