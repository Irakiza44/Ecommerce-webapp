        ...
        <div className='flex flex-col lg:flex-row'>
          ...
          <div className='  ml-[260px]'>
            ...
            <div className='mt-7 -ml-[30px] md:ml-[180px] lg:ml-[26px] font-bold text-3xl flex gap-[345px] '>
              <span>{product.discountPrice}Rwf</span>
              <span className='font-normal line-through'>{product.price}Rwf</span>
            </div>
            <div>
              <div>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="mb-4 mt-4">
              <span className="text-lg font-semibold ">{product.discountPrice}Rwf</span>
              <span className="ml-2 text-sm line-through">{product.price}Rwf</span>
            </div>
            <div>
